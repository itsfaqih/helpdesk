...
test('channel management', async ({ page }) => {
  ...
  await expect(page.getByTestId('heading-page-title')).toHaveText('Create Channel');
  ...
  await expect(page.getByTestId('heading-page-title')).toHaveText('View Channel');
  ...
  await expect(page.getByTestId('table-channels')).toContainText('Test Channel');
  ...
  await expect(page.getByTestId('table-channels')).not.toContainText('Test Channel');

...
test('client management', async ({ page }) => {
  ...
  await expect(page.getByTestId('heading-page-title')).toHaveText('Create Client');
  ...
  await expect(page.getByTestId('heading-page-title')).toHaveText('Edit Client');
  await expect(page.getByTestId('textbox-full-name')).toHaveValue('Test Client');
  ...
  await expect(page.getByTestId('table-clients')).toContainText('Test Client Updated');
  ...
  await expect(page.getByTestId('table-clients')).not.toContainText('Test Client Updated');

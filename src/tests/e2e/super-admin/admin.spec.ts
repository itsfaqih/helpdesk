...
test('admin management', async ({ page }) => {
  ...
  await expect(page.getByTestId('heading-page-title')).toHaveText('Create Administrator');
  ...
  await expect(page.getByTestId('heading-page-title')).toHaveText('Edit Administrator');
  await expect(page.getByTestId('textbox-full-name')).toHaveValue('Test Admin');
  await expect(page.getByTestId('textbox-email')).toHaveValue('test@example.com');
  ...
  await expect(page.getByTestId('table-admins')).toContainText('Test Admin Updated');
  ...
  await expect(page.getByTestId('table-admins')).not.toContainText('Test Admin Updated');

...
export const inputClassName = ({
  ...
  cn(
    "flex rounded-md bg-white file:border-0 file:bg-transparent file:text-sm file:font-medium px-3 py-2 text-sm font-medium focus:outline-brand-600 disabled:cursor-not-allowed disabled:bg-gray-100",
    invalid

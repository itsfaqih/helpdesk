...
export const SelectTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof Ark.SelectTrigger>
>(({ children, className, ...props }, ref) => (
  <Ark.SelectTrigger
    ref={ref}
    className={cn(
      "flex w-full justify-between cursor-default items-center rounded-md bg-white px-3 py-2 text-sm font-medium transition shadow-haptic-gray-300 hover:bg-gray-100",
      className
    )}
    {...props}
  >

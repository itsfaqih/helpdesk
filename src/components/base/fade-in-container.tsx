...
export function FadeInContainer({ from = 'bottom', className, ...props }: FadeInContainerProps) {
  const slideInFrom =
  ...
  return (
    <div className={cn('animate-in fade-in duration-200', slideInFrom, className)} {...props} />
  );
}

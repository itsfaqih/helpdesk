...
const emojiIds = Object.entries((data as { emojis: Record<string, unknown>[] }).emojis).map(
  (emoji) => emoji[0],
);
...
export const IconPicker = React.forwardRef<React.ElementRef<typeof Picker>, IconPickerProps>(
